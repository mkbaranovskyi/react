...
1. https://reactjs.org/docs/hello-world.html - ref
...
To start the basic project, use the `create-react-app` template (here with `ts`):
...
This optional lib provides type validation for props.
...
Making such validation for all your components and their props is a good practice.
