...
- [TypeScript](#typescript)
	...
	- [TypeScript & React](#typescript--react)
		...
		- [Fixing errors](#fixing-errors)
			...
			- [Property 'count' does not exist on type '{ children?: ReactNode; }'](#property-count-does-not-exist-on-type--children-reactnode-)
...
You should use the correct [types for events and event handlers](https://reactjs.org/docs/events.html) to avoid such problems.
...
We have different kinds of functions depending on how we pass them:
...
// GOOD
const MyComponent: React.FC = () => {
	// And here we call a regular function inside our EventHandler (which is not not touched directly)
	const toggleTodo: Function = (): void => {
		console.log(index)
	}
...
#### Property 'count' does not exist on type '{ children?: ReactNode; }'

Error in the **component parameters**. You should explicitly mention what parameters you expect in your component.
