...
- [Redux](#redux)
	...
	- [Practice](#practice)
		- [Simple Redux Counter](#simple-redux-counter)
		- [Counter + Simple Todo](#counter--simple-todo)
...
The callback functon of `UseSelector` receives the full State as a parameter, returns a specific part of that State and subscribes to its changes.
...
- Similar to `mapStateToProps` of `connect`. 
